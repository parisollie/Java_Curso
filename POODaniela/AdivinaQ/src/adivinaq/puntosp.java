 ...
 * @author IlseDaniela
 */
public class puntosp extends javax.swing.JFrame {
double Puntos,JuegosP,JuegosJ,personaje;
String jj,jp,p,pp,ppp;
int PER,Pun;
    /**
     * Creates new form puntosp
     */
    public puntosp() {
        initComponents();
        ...
        if(l==0){
            switch (j){
                case 1:
                    ...
                    puntos.setText("Puntuacion: "+pp);
                    name1.setText(varClave);
            try{
        ...
        name1.setText("Invitado");
        ppp=String.valueOf(Pun);
        puntos.setText("Puntuacion: "+ppp);
        puntos.setText("Puntuacion: "+ppp);
    ...
    private void initComponents() {
        ...
        Menu3.setForeground(new java.awt.Color(0, 0, 51));
        Menu3.setText("¡¡PERDISTE!!");

        puntos.setFont(new java.awt.Font("Andalus", 0, 14)); // NOI18N

        name1.setFont(new java.awt.Font("Andalus", 0, 14)); // NOI18N
        name1.setForeground(new java.awt.Color(51, 0, 51));
        ...
        jLabel1.setFont(new java.awt.Font("Aparajita", 0, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 51));
        jLabel1.setText("EL PERSONAJE ERA");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(puntos, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(puntosp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
