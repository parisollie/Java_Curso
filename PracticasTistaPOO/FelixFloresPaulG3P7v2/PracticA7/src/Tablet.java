...
public class Tablet extends DispositivoMovil {
    ...
    public Tablet( String nombre, String claveDeProducto, double totalDeCompra) {
        super(totalDeCompra,nombre, claveDeProducto);
