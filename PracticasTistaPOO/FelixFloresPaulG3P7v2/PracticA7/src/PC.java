...
public class PC extends Computadora {
    ...
    public PC( String nombre, String claveDeProducto, double totalDeCompra) {
    ...
    public double totalAPagar(){
        if (totalDeCompra>=10000){
            return totalDeCompra-totalDeCompra*0.03;//100000-90000
        }else{
