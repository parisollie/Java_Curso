//28 HEHEGAR
//Mantiene los datos y no los reemplaza
    ...
    public static void main(String[] args) {
        ...
        if (!archivo.exists()) {
            try {
                ...
                //true es para escriba al final de una archivo ya existente
                //es por si hay algo escrito,que se vaya al final
                ...
                Logger.getLogger(ArchivosDeTexto3.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            try {
                System.out.println("Si deseas agregar mas usuarios ,debes compilar el programa nuevamente");
                Nombre = JOptionPane.showInputDialog(null, "Ingresa el nombre: ",
                         "Solicitando datos", 3);
                dir = JOptionPane.showInputDialog(null, "Ingresa la direccion: ",
                         "Solicitando datos", 3);
                email = JOptionPane.showInputDialog(null, "Ingresa el email: ",
                         "Solicitando datos", 3);
                //true es para escriba al final de una rchivo ya existente
                escribir = new FileWriter(archivo, true);
