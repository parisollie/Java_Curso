...
public class ErroresDeExcepciones {
    ...
    public static void main(String[] args) {
       ...
       // Para que nos diga si ocurrio algun error.
        ...
        try{
            /*Código donde puede ocurrir una exepción o un error
            lo almacenamos en x*/
            x=Integer.parseInt(JOptionPane.showInputDialog(null,
                    "Ingresa un número entero: ","Solicitando Datos",3));
            
            y=Integer.parseInt(JOptionPane.showInputDialog(null,
                    "Ingresa otro número entero: ", "Solicitando Datos",3));
            
            JOptionPane.showMessageDialog(null, "La divicion de " + x + "/"+
                     y+ " es " + (x/y),"Mostrando resultado",1);
            
            /* i<=5 Un índice en donde la posición no existe
            int vector [] = {1,4,6,3,2};, aqui no hay 5,asi que mandará
            una excepción.*/
            for(i=0 ; i<=5 ; i++){ 
                System.out.println("["+vector [i]+"]");
            }
            
         /*Va el tipo de error ahí,NumberFormatException significa que se metio
         una letra*/
        ...
        //Capturamos otra excepción dentro de esta para que no dividamos entre cero. 
