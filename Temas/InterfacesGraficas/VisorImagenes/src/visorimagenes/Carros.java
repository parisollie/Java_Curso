...
public class Carros extends javax.swing.JFrame {
    ...
    public Carros() {
        initComponents();
        this.setTitle("Agencia de carros");
        for(int i =1 ; i<7 ; i++){
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/visorimagenes/Imagenes/fondo.jpg"))); // NOI18N
        ...
        do {
            try {
                dato = Integer.parseInt(JOptionPane.showInputDialog(null,
                        ...
                        + "6.Beetle\n"
                        + "7.Salir\n"
                        + "Elige una opcion...", "Caracteristicas del carro", JOptionPane.QUESTION_MESSAGE));

                switch (dato) {

                    case 1:
                        JOptionPane.showMessageDialog(null, "MINICopper");
                        JOptionPane.showMessageDialog(null, "Cantidad de pasajeros: 4 " + "\nColores: [Rojo-Rosa-Azul-Verde] "
                                + "\nAño: 2015-2019 " + "\nMarca: MINICoper " + 
                              "\nPrecio: [$500,000-$700,000] " , " Auto deportivo",
                                JOptionPane.INFORMATION_MESSAGE);
                        break;
                    case 2:
                        JOptionPane.showMessageDialog(null, "Ferrari");
                        JOptionPane.showMessageDialog(null, "Cantidad de pasajeros: 2-4 " + "\nColores:[Rojo-Rosa-Azul-Amarillo] "
                                + "\nAño: 2018-2019 " + "\nMarca: Ferrari " + 
                              "\nPrecio: [$1,4500,000-$1,500,000] " , " Auto de lujo",
                                JOptionPane.INFORMATION_MESSAGE);
                        break;
                    case 3:
                        JOptionPane.showMessageDialog(null, "Camioneta");
                        JOptionPane.showMessageDialog(null, "Cantidad de pasajeros: 2-6 " + "\nColores: [Rojo-Negro-Azul-Rojo] "
                                + "\nAño: 2018-2019 " + "\nMarcas: Ford y Chevrolet " + 
                              "\nPrecio: [$500,000-$854,000] "+"\nCantidad de carga: [400-700] kg" , " Camioneta",
                                JOptionPane.INFORMATION_MESSAGE);
                        break;
                    case 4:
                        JOptionPane.showMessageDialog(null, "Van");
                        JOptionPane.showMessageDialog(null, "Cantidad de pasajeros: 6-8 " + "\nColores: [Rojo-Gris-Azul-Blanco] "
                                + "\nAño: 2016-2019 " + "\nMarca: Volkswagen " + 
